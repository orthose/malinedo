...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.CharField(choices=[('L', 'Loisir'), ('J', 'Jeune'), ('C1', 'Compétition N1'), ('C2', 'Compétition N2')], max_length=2, verbose_name='Groupe')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('register_coach_session', "Le nageur peut s'inscrire en tant qu'entraîneur à une session"), ('register_leisure_session', "Le nageur en loisir peut s'inscrire à une session de loisir"), ('register_young_session', "Le jeune nageur peut s'inscrire à une session de jeune"), ('register_competn1_session', "Le nageur en compétition peut s'inscrire à une session de compétition de niveau 1"), ('register_competn2_session', "Le nageur en compétition peut s'inscrire à une session de compétition de niveau 2")],
